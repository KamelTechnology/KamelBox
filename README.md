![screenshot](https://raw.githubusercontent.com/KamelTechnology/KamelBox_images/master/.assets/photo.jpg)

<p align="center">
    <a href="https://github.com/mickael-kerjean/contributors" alt="Contributors">
        <img src="https://img.shields.io/github/contributors/KamelTechnology/KamelBox" style="max-width:100%;">
    </a>
    ...
    <br>
    <a href="#" alt="Build">
        <img src="https://github.com/KamelTechnology/KamelBox/actions/workflows/ci.yml/badge.svg" style="max-width:100%;">
    </a>
...
<p align="center">
    <a href="http://demo.filestash.app">
      <img src="https://raw.githubusercontent.com/KamelTechnology/KamelBox_images/master/.assets/button_demo.png" alt="demo button" />
    </a>
</p>
...
<p align="center">
    <a href="https://demo.filestash.app">
        <img src="https://raw.githubusercontent.com/KamelTechnology/KamelBox_images/master/.assets/navigation.gif" alt="user experience on navigation" />
    </a>
</p>
<p align="center">
    <a href="http://demo.filestash.app">
        <img src="https://raw.githubusercontent.com/KamelTechnology/KamelBox_images/master/.assets/photo_management.gif" alt="user experience on medias" />
    </a>
</p>
...
# Credits
- [Contributors](https://github.com/KamelTechnology/KamelBox/graphs/contributors) and folks developing [awesome libraries](https://github.com/KamelTechnology/KamelBox/blob/master/go.mod)
...
- [libvips](https://github.com/libvips/libvips) and [libraw](https://github.com/LibRaw/LibRaw). Those libraries are statically compiled in Filestash. Instructions to build Filestash is available [here](https://github.com/KamelTechnology/KamelBox/blob/master/.drone.yml) and instructions to create your own static library for libvips and libraw is to be found [here](https://github.com/KamelTechnology/KamelBox/tree/master/server/plugin/plg_image_light/deps)
